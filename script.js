document.addEventListener("DOMContentLoaded", function () {
    ...
    const menuItems = {
        ...
        "Bread and Sandwiches": [
            ...
            { id: 26, name: "Garlic Bread", price: 4.00, image: "Images/muffins.jpg" },
            { id: 27, name: "Chicken Burger", price: 4.00, image: "Images/muffins.jpg" },
            { id: 28, name: "Bacon Burger", price: 4.00, image: "Images/muffins.jpg" },
            { id: 29, name: "Cheese Burger", price: 4.00, image: "Images/muffins.jpg" }, 
        ],
        "Beverages": [
            { id: 30, name: "Hot-Coffee", price: 2.50, image: "Images/muffins.jpg" },
            { id: 31, name: "Iced-Coffee", price: 4.50, image: "Images/muffins.jpg" },
            { id: 32, name: "Americano", price: 5.00, image: "Images/muffins.jpg" },
            { id: 33, name: "Cafe-Latte", price: 5.00, image: "Images/muffins.jpg" },
            { id: 34, name: "Espresso", price: 5.00, image: "Images/muffins.jpg" },
            { id: 35, name: "Match-Latte", price: 5.00, image: "Images/muffins.jpg" },
            { id: 36, name: "Vanilla-Milk Shake", price: 5.00, image: "Images/muffins.jpg" },
            { id: 37, name: "Chocolate-Milk Shake", price: 5.00, image: "Images/muffins.jpg" },
            { id: 38, name: "Strawberry-Milk Shake", price: 5.00, image: "Images/muffins.jpg" },
            { id: 39, name: "Bubble-Tea", price: 5.00, image: "Images/muffins.jpg" },
